    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK){
                ...
                Uri resultUri = result.getUri(); //crop image
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot,
                    ...
                    public void onComplete(Task<Uri> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SettingsActivity.this, "Uploaded" + downloadUri, Toast.LENGTH_SHORT).show();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if ((dataSnapshot.exists()) && (dataSnapshot.hasChild("name") && (dataSnapshot.hasChild("image")))){
                            ...
                            Picasso.get().load(retrieveProfileImage).into(userProfileImage);  //display image picasso
